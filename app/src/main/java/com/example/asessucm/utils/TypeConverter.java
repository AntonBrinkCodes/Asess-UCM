...
/**
 * Completely taken from on Ble-Gatt-Movesense-2.0 from https://gits-15.sys.kth.se/anderslm/Ble-Gatt-Movesense-2.0
 */
public class TypeConverter {
    //TODO: CHANGE TO WORK FOR POLAR INSTEAD OF MOVESENSE?
    /**
    ...
    public static byte[] stringToAsciiArray(byte id, String command) {
        ...
        for (int i = 0; i < chars.length; i++) {
            ...
            Log.i("Typeconverter", String.valueOf(ascii[i]));
        }
